...
static int mem_read(State *s, int size, unsigned int address)
{
   ...
   {
      case 4: 
         if (address & 3) printf("[ERROR] Unaligned 32-bit access PC=0x%x address=0x%x\n", (int)s->pc, (int)address);
         value = *(int*)ptr;
         if(s->big_endian) 
            value = ntohl(value);
         break;
      case 2:
         if (address & 1) printf("[ERROR] Unaligned 16-bit access PC=0x%x address=0x%x\n", (int)s->pc, (int)address);
   ...
   dataQueuePush(1,size,address,value);
...
static void mem_write(State *s, int size, int unsigned address, unsigned int value)
{
   ...
   */
   ...
   dataQueuePush(0,size,address,value);
...
void cycle(State *s, int show_mode)
{
   ...
   /* pc_next is set to the branch target after the instruction decode at the end of this function .. */

   /*    printf("[DEBUG] C Model : pc = 0x%x, pc_next = 0x%x at start of function\n", s->pc, s->pc_next); */
   ...
   /* printf("[DEBUG] C Model : pc = 0x%x, pc_next = 0x%x just after start of function\n", s->pc, s->pc_next); */
   ...
   switch(op) 
   {
      case 0x00:/*SPECIAL*/
	    ...
	    case 0x09:/*JALR*/ r[rd]=s->pc_next+4; s->pc_next=r[rs]; break;  /* Store PC+8 in link reg (instr after delay slot) */
      ...
      case 0x01:/*REGIMM*/
         switch(rt) {
	    case 0x10:/*BLTZAL*/ r[31]=s->pc_next + 4; 
            case 0x00:/*BLTZ*/   branch=r[rs]<0;    break;
            case 0x11:/*BGEZAL*/ r[31]=s->pc_next + 4; 
            case 0x01:/*BGEZ*/   branch=r[rs]>=0;   break;
            case 0x12:/*BLTZALL*/r[31]=s->pc_next + 4; 
            case 0x02:/*BLTZL*/  lbranch=r[rs]<0;   break;
            case 0x13:/*BGEZALL*/r[31]=s->pc_next + 4;
            case 0x03:/*BGEZL*/  lbranch=r[rs]>=0;  break;
            default: printf("ERROR1\n"); s->wakeup=1;
          }
         break;
      case 0x03:/*JAL*/    r[31]=s->pc_next + 4; 
   ...
   /* Debugging - print when a branch should be taken and what to .. */
   /*    printf("[C DBG] C Model : Branch = %01d, Target = 0x%x\n", (branch || lbranch == 1), imm_shift);*/
   ...
   for(;;) 
   {
	...
	/* scanf("%x", &watch); */
      ...
      case '8': case 'j':
         printf("Jump> ");
	/* scanf("%x", &addr); */
	addr = 0; /* need to set addr to something as scanf isn't available. Set to 0 */
         s->pc = addr;
         s->pc_next = addr + 4;
         show_state(s);
         break;
 ...
 *     s->pc = 0x10000000;
*/
   /* do_debug(s); <- called by the verilog testcase */
...
/* step function  */
/* execute one cycle of a Plasma CPU */
void cpuCycle(int pc, int opcode, int show_mode)
{
  /* unsigned int opcode; */
   State *s=&cpuState;
   /*   int show_mode = 1; */
 ...
 */
   ...
   case 0x00:/*SPECIAL*/
     switch(func) 
       {
       case 0x00:/*SLL*/  r[rd]=r[rt]<<re          	    	      ; regQueuePush(rd,r[rd]); break;
       case 0x02:/*SRL*/  r[rd]=u[rt]>>re          	    	      ; regQueuePush(rd,r[rd]); break;
       case 0x03:/*SRA*/  r[rd]=r[rt]>>re          	    	      ; regQueuePush(rd,r[rd]); break;
       case 0x04:/*SLLV*/ r[rd]=r[rt]<<r[rs]       	    	      ; regQueuePush(rd,r[rd]); break;
       case 0x06:/*SRLV*/ r[rd]=u[rt]>>r[rs]       	    	      ; regQueuePush(rd,r[rd]); break;
       case 0x07:/*SRAV*/ r[rd]=r[rt]>>r[rs]       	    	      ; regQueuePush(rd,r[rd]); break;    
       case 0x08:/*JR*/   s->pc_next=r[rs]                     	      ; regQueuePush(0, 0); jump=1; break; /* target and delay slot PC set at end of function. The encoding of the instruction writes to reg 0  */
       case 0x09:/*JALR*/ r[rd]=s->pc_next+4; s->pc_next=r[rs]   	      ; regQueuePush(rd,r[rd]); jump=1; break; /* target and delay slot PC set at end of function */
       ...
       case 0x10:/*MFHI*/ r[rd]=s->hi               	    	      ; regQueuePush(rd,s->hi)  ; break;
       case 0x11:/*MTHI*/ s->hi=r[rs]               	    	      ; regQueuePush(0,r[rs])  ; loHiQueuePush(1, s->hi) ; break; /* The MTHI and MTLO instructions also write the same value to reg 0 (easier decode)*/
       case 0x12:/*MFLO*/ r[rd]=s->lo               	    	      ; regQueuePush(rd,s->lo)  ; break;
       case 0x13:/*MTLO*/ s->lo=r[rs]               	    	      ; regQueuePush(0,r[rs])  ; loHiQueuePush(0, s->lo) ; break; /* The MTHI and MTLO instructions also write the same value to reg 0 (easier decode)*/    
       case 0x18:/*MULT*/ mult_big_signed(r[rs],r[rt],&s->hi,&s->lo)  ; regQueuePush(0, 0); loHiQueuePush(0, s->lo) ; loHiQueuePush(1, s->hi); break; /* the mult instructions end up writing to register 0 due to the encoding .. */
       case 0x19:/*MULTU*/ mult_big(r[rs],r[rt],&s->hi,&s->lo)        ; regQueuePush(0, 0); loHiQueuePush(0, s->lo) ; loHiQueuePush(1, s->hi); break; 
       case 0x1a:/*DIV*/  s->lo=r[rs]/r[rt]; s->hi=r[rs]%r[rt]        ; regQueuePush(0, 0); loHiQueuePush(0, s->lo) ; loHiQueuePush(1, s->hi) ; break; /* the div instructions end up writing to register 0 due to the encoding .. */
       case 0x1b:/*DIVU*/ s->lo=u[rs]/u[rt]; s->hi=u[rs]%u[rt]        ; regQueuePush(0, 0); loHiQueuePush(0, s->lo) ; loHiQueuePush(1, s->hi) ; break;
       case 0x20:/*ADD*/  r[rd]=r[rs]+r[rt]                           ; regQueuePush(rd,r[rd]) ; break;
       case 0x21:/*ADDU*/ r[rd]=r[rs]+r[rt]                           ; regQueuePush(rd,r[rd]) ; break;
       case 0x22:/*SUB*/  r[rd]=r[rs]-r[rt]                           ; regQueuePush(rd,r[rd]) ; break;
       case 0x23:/*SUBU*/ r[rd]=r[rs]-r[rt]                           ; regQueuePush(rd,r[rd]) ; break;
       case 0x24:/*AND*/  r[rd]=r[rs]&r[rt]                           ; regQueuePush(rd,r[rd]) ; break;
       case 0x25:/*OR*/   r[rd]=r[rs]|r[rt]                           ; regQueuePush(rd,r[rd]) ; break;
       case 0x26:/*XOR*/  r[rd]=r[rs]^r[rt]                           ; regQueuePush(rd,r[rd]) ; break;
       case 0x27:/*NOR*/  r[rd]=~(r[rs]|r[rt])                        ; regQueuePush(rd,r[rd]) ; break;
       case 0x2a:/*SLT*/  r[rd]=r[rs]<r[rt]                           ; regQueuePush(rd,r[rd]) ; break;
       case 0x2b:/*SLTU*/ r[rd]=u[rs]<u[rt]                           ; regQueuePush(rd,r[rd]) ; break;
       case 0x2d:/*DADDU*/r[rd]=r[rs]+u[rt]                           ; regQueuePush(rd,r[rd]) ; break; 
       case 0x31:/*TGEU*/ break;
       case 0x32:/*TLT*/  break;
       case 0x33:/*TLTU*/ break;
       case 0x34:/*TEQ*/  break;
	 ...
	 s->wakeup=1;
      ...
      case 0x01:/*REGIMM*/
         switch(rt) {
            case 0x10:/*BLTZAL*/ r[31]=s->pc_next + 4  ; regQueuePush(31,r[31]) ;
            case 0x00:/*BLTZ*/   branch=r[rs]<0    ;  break;
            case 0x11:/*BGEZAL*/ r[31]=s->pc_next + 4  ; regQueuePush(31,r[31]) ;
            case 0x01:/*BGEZ*/   branch=r[rs]>=0   ;  break;
            case 0x12:/*BLTZALL*/r[31]=s->pc_next + 4  ; regQueuePush(31,r[31]) ; 
            case 0x02:/*BLTZL*/  lbranch=r[rs]<0   ;  break;
            case 0x13:/*BGEZALL*/r[31]=s->pc_next + 4  ; regQueuePush(31,r[31]) ; 
            case 0x03:/*BGEZL*/  lbranch=r[rs]>=0  ;  break;
            default: printf("ERROR1\n"); s->wakeup=1;
          }
         break;
      case 0x03:/*JAL*/    r[31]=s->pc_next + 4                 ; regQueuePush(31,r[31]); jump=1;
      ...
      case 0x08:/*ADDI*/   r[rt]=r[rs]+(short)imm               ; regQueuePush(rt,r[rt]); break;
      case 0x09:/*ADDIU*/  u[rt]=u[rs]+(short)imm               ; regQueuePush(rt,u[rt]); break; 
      case 0x0a:/*SLTI*/   r[rt]=r[rs]<(short)imm               ; regQueuePush(rt,r[rt]); break;
      case 0x0b:/*SLTIU*/  u[rt]=u[rs]<(unsigned int)(short)imm ; regQueuePush(rt,u[rt]); break;
      case 0x0c:/*ANDI*/   r[rt]=r[rs]&imm                      ; regQueuePush(rt,r[rt]); break;
      case 0x0d:/*ORI*/    r[rt]=r[rs]|imm                      ; regQueuePush(rt,r[rt]); break;
      case 0x0e:/*XORI*/   r[rt]=r[rs]^imm                      ; regQueuePush(rt,r[rt]); break;
      case 0x0f:/*LUI*/    r[rt]=(imm<<16)                      ; regQueuePush(rt,r[rt]); break;
      case 0x10:/*COP0*/
	if((opcode & (1<<23)) == 0)  /* move from CP0 */
         {
            if(rd == 12)
      ...
      case 0x1c:/*MAD*/  break;   /*IV*/
      case 0x20:/*LB*/   r[rt]=(signed char)mem_read(s,1,ptr)    ; regQueuePush(rt,r[rt]); break;
      case 0x21:/*LH*/   r[rt]=(signed short)mem_read(s,2,ptr)   ; regQueuePush(rt,r[rt]); break;
      case 0x22:/*LWL*/  
	/* target=8*(ptr&3); */
	/* r[rt]=(r[rt]&~(0xffffffff<<target))| */
	/*       (mem_read(s,4,ptr&~3)<<target); break; */
      case 0x23:/*LW*/   r[rt]=mem_read(s,4,ptr)                 ; regQueuePush(rt,r[rt]); break; /* Stores push the data queue in the mem_write function */
      case 0x24:/*LBU*/  r[rt]=(unsigned char)mem_read(s,1,ptr)  ; regQueuePush(rt,r[rt]); break;
      case 0x25:/*LHU*/  r[rt]=(unsigned short)mem_read(s,2,ptr) ; regQueuePush(rt,r[rt]); break;
      case 0x26:/*LWR*/  
	/* target=32-8*(ptr&3); */
	/* r[rt]=(r[rt]&~((unsigned int)0xffffffff>>target))| */
	/* ((unsigned int)mem_read(s,4,ptr&~3)>>target);  */
                         break;
      case 0x28:/*SB*/   mem_write(s,1,ptr,r[rt])                ; break; /* Stores push the data queue in the mem_write function */
      case 0x29:/*SH*/   mem_write(s,2,ptr,r[rt])                ; break;
      case 0x2a:/*SWL*/  
	/* mem_write(s,1,ptr,r[rt]>>24);   */
	/* mem_write(s,1,ptr+1,r[rt]>>16); */
	...
	/* mem_write(s,1,ptr+3,r[rt]); break; */
      ...
      case 0x2e:/*SWR*/  break; /* fixme */
      case 0x2f:/*CACHE*/break;
      case 0x30:/*LL*/   r[rt]=mem_read(s,4,ptr)                 ; regQueuePush(rt,r[rt]); break;
      case 0x31:/*LWC1*/ break;
      case 0x32:/*LWC2*/ break;
      case 0x33:/*LWC3*/ break;
      case 0x35:/*LDC1*/ break;
