...
/* 0xbfc0_0000 is the reset value of the PC */	
	...
	ori $5, 0x0010
	sw  $0, 0($5)	 /* Save 0 into address 0x10 */
	nop
	nop
	
	lw  $6, 0($5)    /* Cause the CPU to take an address error (data load) */
	nop
	nop
	nop
...
2:	
	li       $5, 0x10           /* 10 is the offending address */
