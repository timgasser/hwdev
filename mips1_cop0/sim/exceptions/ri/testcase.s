...
/* 0xbfc0_0000 is the reset value of the PC */	
	...
	li $10, 2			/* Assume test fail initially (non-zero $10) */

	nop
	nop
	nop
	
	nop              /* Testbench overrides this value with a reserved instruction */
	nop
	nop
	nop
...
1:	andi     $27, $27, 0x007c   /* get exception code from Cause [6:2] */
	...
	li       $5, 10             /* 10 is the reserved instruction code */ 
