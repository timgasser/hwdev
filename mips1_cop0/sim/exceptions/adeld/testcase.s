...
/* 0xbfc0_0000 is the reset value of the PC */	
	...
	lh  $6, 0($5)    /* Cause the CPU to take an address error (data load) */
	nop
	nop
	nop

	sh    $10, 0($0) /* Once the exception is serviced, store the amount of errors (detected by TB) */ 
	nop                 
	nop
	nop 
...
2:	
	li       $5, 0x11           /* 11 is the offending address */
